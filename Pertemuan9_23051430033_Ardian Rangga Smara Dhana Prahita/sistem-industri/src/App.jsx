...
function App() {
  // 1. Simpan data dalam bentuk Array (lebih rapi dan mudah dikelola)
  const daftarMesin = [
  ...
  return (
    <div className="container mt-5">
      {/* Header dengan sedikit styling tambahan */}
      ...
      <div className="row g-4"> 
        {/* 2. Gunakan .map() untuk menampilkan komponen secara otomatis */}
